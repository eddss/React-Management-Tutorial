        ...
        return (
            <div>
                ...
                <Dialog open={this.state.open} onClose={this.handleClickClose}>
                    ...
                    <DialogContent>
                        <input className={classes.hidden} accept="image/*" type="file" file={this.state.file} id="raised-button-file" value={this.state.fileName} onChange={this.handleFileChange}></input>
                        ...
                        <TextField label="생일" type="text" name="birth" value={this.state.birth} onChange={this.handleValueChange}></TextField><br/>
            ...
            //     생일: <input type="text" name="birth" value={this.state.birth} onChange={this.handleValueChange}></input><br/>
